...
var or__30182__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
...
return (new CustomEvent(event_name,(function (){var obj45373 = {"detail":data};
return obj45373;
})()));
} else {
...
if(cljs.core.truth_((function (){var and__30170__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
if(cljs.core.truth_(and__30170__auto__)){
var and__30170__auto____$1 = goog.object.get(window,"CustomEvent");
...
var f = (function (){var pred__45380 = cljs.core._EQ_;
var expr__45381 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__45380.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__45381))){
return ((function (pred__45380,expr__45381){
return (function (p1__45374_SHARP_){
return console.warn(p1__45374_SHARP_);
});
;})(pred__45380,expr__45381))
} else {
if(cljs.core.truth_(pred__45380.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__45381))){
return ((function (pred__45380,expr__45381){
return (function (p1__45375_SHARP_){
return console.debug(p1__45375_SHARP_);
});
;})(pred__45380,expr__45381))
} else {
if(cljs.core.truth_(pred__45380.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__45381))){
return ((function (pred__45380,expr__45381){
return (function (p1__45376_SHARP_){
return console.error(p1__45376_SHARP_);
});
;})(pred__45380,expr__45381))
} else {
return ((function (pred__45380,expr__45381){
return (function (p1__45377_SHARP_){
return console.log(p1__45377_SHARP_);
});
;})(pred__45380,expr__45381))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__45384){
...
var eval_fn = cljs.core.get.call(null,map__45385__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return (function (p1__45387_SHARP_){
return new_def.callback(p1__45387_SHARP_);
});})(new_def))
);
...
return (function (p__45388){
var vec__45389 = p__45388;
var ky = cljs.core.nth.call(null,vec__45389,(0),null);
...
if(cljs.core.truth_((function (){var and__30170__auto__ = typeof localStorage !== 'undefined';
...
//# sourceMappingURL=utils.js.map?rel=1511550759456
