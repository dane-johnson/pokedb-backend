...
var len__31459__auto___48634 = arguments.length;
var i__31460__auto___48635 = (0);
while(true){
if((i__31460__auto___48635 < len__31459__auto___48634)){
args__31466__auto__.push((arguments[i__31460__auto___48635]));

var G__48636 = (i__31460__auto___48635 + (1));
i__31460__auto___48635 = G__48636;
continue;
} else {
}
break;
...
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__31467__auto__);
});
...
devtools.formatters.state.update_current_state_BANG_.cljs$lang$applyTo = (function (seq48632){
var G__48633 = cljs.core.first.call(null,seq48632);
var seq48632__$1 = cljs.core.next.call(null,seq48632);
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__48633,seq48632__$1);
});
...
return (p1__48637_SHARP_ === object);
});})(history))
,history);
});
...
//# sourceMappingURL=state.js.map?rel=1511550780128
