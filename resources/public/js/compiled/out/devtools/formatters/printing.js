...
var len__31459__auto___48643 = arguments.length;
var i__31460__auto___48644 = (0);
while(true){
if((i__31460__auto___48644 < len__31459__auto___48643)){
args__31466__auto__.push((arguments[i__31460__auto___48644]));

var G__48645 = (i__31460__auto___48644 + (1));
i__31460__auto___48644 = G__48645;
continue;
} else {
}
break;
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__31467__auto__);
});
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq48640){
var G__48641 = cljs.core.first.call(null,seq48640);
var seq48640__$1 = cljs.core.next.call(null,seq48640);
var G__48642 = cljs.core.first.call(null,seq48640__$1);
var seq48640__$2 = cljs.core.next.call(null,seq48640__$1);
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__48641,G__48642,seq48640__$2);
});
...
if(cljs.core.truth_((function (){var or__30182__auto__ = devtools.formatters.helpers.directly_printable_QMARK_.call(null,value);
...
devtools.formatters.printing.TemplateWriter.cljs$lang$ctorPrWriter = (function (this__30853__auto__,writer__30854__auto__,opt__30855__auto__){
return cljs.core._write.call(null,writer__30854__auto__,"devtools.formatters.printing/TemplateWriter");
});
...
if(cljs.core.truth_((function (){var and__30170__auto__ = cljs.core.not.call(null,devtools.formatters.printing.already_reference_QMARK_.call(null,group));
if(and__30170__auto__){
var or__30182__auto__ = devtools.formatters.helpers.expandable_QMARK_.call(null,obj);
if(cljs.core.truth_(or__30182__auto__)){
return or__30182__auto__;
} else {
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__48646_SHARP_){
return !((cljs.core.meta.call(null,p1__48646_SHARP_) == null));
})))){
...
var map__48647 = opts;
var map__48647__$1 = ((((!((map__48647 == null)))?((((map__48647.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__48647.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__48647):map__48647);
var markup_db = cljs.core.get.call(null,map__48647__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
if(cljs.core.truth_((function (){var or__30182__auto__ = (function (){try{if(!((obj == null))){
...
}catch (e48651){var _e__47631__auto__ = e48651;
return false;
}})();
if(cljs.core.truth_(or__30182__auto__)){
return or__30182__auto__;
...
}catch (e48653){var _e__47631__auto__ = e48653;
return false;
}}
})())){
...
var _STAR_current_state_STAR_48655 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__48656 = opts;
...
var markup_db = cljs.core.get.call(null,map__48656__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_48655;
}});
...
;
var temp__5276__auto___48660 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5276__auto___48660)){
var managed_print_level_48661 = temp__5276__auto___48660;
var _STAR_print_level_STAR_48659_48662 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_48661;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_48659_48662,managed_print_level_48661,temp__5276__auto___48660,writer,opts,job_fn){
return (function (p1__48658_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__48658_SHARP_,null);
});})(_STAR_print_level_STAR_48659_48662,managed_print_level_48661,temp__5276__auto___48660,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_48659_48662;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1511550780192
