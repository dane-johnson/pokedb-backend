...
var G__48614 = devtools.prefs.pref.call(null,v);
v = G__48614;
continue;
} else {
return v;
...
var and__30170__auto__ = cljs.core.not.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"disable-cljs-fn-formatting","disable-cljs-fn-formatting",1903786837)));
if(and__30170__auto__){
var and__30170__auto____$1 = !(cljs.core.var_QMARK_.call(null,value));
...
var or__30182__auto__ = (function (){try{if(!((value == null))){
...
}catch (e48617){var _e__47631__auto__ = e48617;
return false;
}})();
if(cljs.core.truth_(or__30182__auto__)){
return or__30182__auto__;
} else {
var or__30182__auto____$1 = (function (){try{if(!((value == null))){
...
}catch (e48621){var _e__47631__auto__ = e48621;
return false;
}})();
...
}catch (e48623){var _e__47631__auto__ = e48623;
return false;
}}
}
});
devtools.formatters.helpers.cljs_type_QMARK_ = (function devtools$formatters$helpers$cljs_type_QMARK_(f){
var and__30170__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__30170__auto__)){
var and__30170__auto____$1 = cljs.core.not.call(null,devtools.formatters.helpers.is_prototype_QMARK_.call(null,f));
if(and__30170__auto____$1){
...
var and__30170__auto__ = goog.isObject(value);
if(cljs.core.truth_(and__30170__auto__)){
...
var or__30182__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(or__30182__auto__)){
return or__30182__auto__;
} else {
...
var and__30170__auto__ = (function (){var or__30182__auto__ = devtools.formatters.helpers.cljs_land_value_QMARK_.call(null,value);
if(cljs.core.truth_(or__30182__auto__)){
return or__30182__auto__;
} else {
...
var vec__48625 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__48625,(0),null);
var name = cljs.core.nth.call(null,vec__48625,(1),null);
...
var and__30170__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(and__30170__auto__)){
...
var or__30182__auto__ = typeof value === 'string';
if(or__30182__auto__){
return or__30182__auto__;
} else {
var or__30182__auto____$1 = typeof value === 'number';
...
return cljs.core.some.call(null,(function (p1__48628_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__48628_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1511550780101
