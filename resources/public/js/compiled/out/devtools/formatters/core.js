...
var and__30170__auto__ = cljs.core.not.call(null,devtools.formatters.state.prevent_recursion_QMARK_.call(null));
if(and__30170__auto__){
var or__30182__auto__ = devtools.formatters.helpers.cljs_value_QMARK_.call(null,value);
...
}catch (e49123){var _e__47631__auto__ = e49123;
return false;
...
}catch (e49125){var _e__47631__auto__ = e49125;
return false;
...
}catch (e49127){var _e__47631__auto__ = e49127;
return false;
...
}catch (e49129){var _e__47631__auto__ = e49129;
return false;
...
}catch (e49131){var _e__47631__auto__ = e49131;
return false;
}})())){
...
}catch (e49133){var _e__47631__auto__ = e49133;
return false;
}})())){
...
var _STAR_current_state_STAR_49135 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = (function (){var or__30182__auto__ = config;
if(cljs.core.truth_(or__30182__auto__)){
return or__30182__auto__;
} else {
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_49135;
}});
});
...
return (function() { 
var G__49137__delegate = function (args){
try{return cljs.core.apply.call(null,f,args);
}catch (e49136){var e = e49136;
devtools.reporter.report_internal_error_BANG_.call(null,e,"an exception was raised during value formatting");

return null;
}};
var G__49137 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__49138__i = 0, G__49138__a = new Array(arguments.length -  0);
while (G__49138__i < G__49138__a.length) {G__49138__a[G__49138__i] = arguments[G__49138__i + 0]; ++G__49138__i;}
  args = new cljs.core.IndexedSeq(G__49138__a,0,null);
} 
return G__49137__delegate.call(this,args);};
G__49137.cljs$lang$maxFixedArity = 0;
G__49137.cljs$lang$applyTo = (function (arglist__49139){
var args = cljs.core.seq(arglist__49139);
return G__49137__delegate(args);
});
G__49137.cljs$core$IFn$_invoke$arity$variadic = G__49137__delegate;
return G__49137;
})()
;
});
...
var pre_handler = (function (){var or__30182__auto__ = devtools.prefs.pref.call(null,pre_handler_key);
if(cljs.core.truth_(or__30182__auto__)){
return or__30182__auto__;
} else {
...
var post_handler = (function (){var or__30182__auto__ = devtools.prefs.pref.call(null,post_handler_key);
if(cljs.core.truth_(or__30182__auto__)){
return or__30182__auto__;
} else {
return cljs.core.identity;
...
//# sourceMappingURL=core.js.map?rel=1511550780832
