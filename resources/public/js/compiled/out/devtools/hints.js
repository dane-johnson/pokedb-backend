...
var reader = (function (){var or__30182__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"file-reader","file-reader",-450847664));
...
var min_length = (function (){var or__30182__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"sanity-hint-min-length","sanity-hint-min-length",104958154));
if(cljs.core.truth_(or__30182__auto__)){
return or__30182__auto__;
} else {
return (128);
...
var map__49330 = top_item;
var map__49330__$1 = ((((!((map__49330 == null)))?((((map__49330.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__49330.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__49330):map__49330);
...
}catch (e49329){var _e = e49329;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5276__auto___49332 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5276__auto___49332)){
var seen_errors_49333 = temp__5276__auto___49332;
if(cljs.core.truth_(seen_errors_49333.has(self))){
} else {
seen_errors_49333.add(self);

var temp__5278__auto___49334 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5278__auto___49334)){
var sense_49335 = temp__5278__auto___49334;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_49335)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1511550781132
