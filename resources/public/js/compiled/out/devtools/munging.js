...
var o48512 = temp__5276__auto__;
var temp__5276__auto____$1 = (o48512["core"]);
if(cljs.core.truth_(temp__5276__auto____$1)){
var o48513 = temp__5276__auto____$1;
return (o48513["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__47624__auto__ = f;
return (o__47624__auto__["toString"]).call(o__47624__auto__);
} else {
return "";
}
}catch (e48514){var _ = e48514;
return "";
}});
...
try{var o__47624__auto___48516 = t;
(o__47624__auto___48516["cljs$lang$ctorPrWriter"]).call(o__47624__auto___48516,t,writer);
}catch (e48515){var __48517 = e48515;
}
...
var char_code = (function (){var o__47624__auto__ = (new String(char$));
return (o__47624__auto__["charCodeAt"]).call(o__47624__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__47624__auto__ = String;
return (o__47624__auto__["fromCharCode"]).call(o__47624__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__48518 = num_code;
switch (G__48518) {
case (1):
return (185);
...
var o__47624__auto__ = String;
return (o__47624__auto__["fromCharCode"]).call(o__47624__auto__,superscript_code);
});
/**
...
}catch (e48520){var _e__47631__auto__ = e48520;
return false;
}})())){
...
var vec__48521 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__48521,(0),null);
...
var or__30182__auto__ = (function (){var temp__5276__auto__ = cljs.core.re_matches.call(null,/(.*)\$/,s);
if(cljs.core.truth_(temp__5276__auto__)){
...
if(cljs.core.truth_(temp__5276__auto__)){
var o48524 = temp__5276__auto__;
var temp__5276__auto____$1 = (o48524["dependencies_"]);
if(cljs.core.truth_(temp__5276__auto____$1)){
var o48525 = temp__5276__auto____$1;
return (o48525["nameToPath"]);
} else {
return null;
}
} else {
...
var len__31459__auto___48532 = arguments.length;
var i__31460__auto___48533 = (0);
while(true){
if((i__31460__auto___48533 < len__31459__auto___48532)){
args__31466__auto__.push((arguments[i__31460__auto___48533]));

var G__48534 = (i__31460__auto___48533 + (1));
i__31460__auto___48533 = G__48534;
continue;
} else {
}
break;
...
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__31467__auto__);
});

devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__48528){
var vec__48529 = p__48528;
var ns_detector = cljs.core.nth.call(null,vec__48529,(0),null);
var effective_detector = (function (){var or__30182__auto__ = ns_detector;
if(cljs.core.truth_(or__30182__auto__)){
return or__30182__auto__;
} else {
...
var G__48535 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__48536 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__48535;
remaining_tokens = G__48536;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq48526){
var G__48527 = cljs.core.first.call(null,seq48526);
var seq48526__$1 = cljs.core.next.call(null,seq48526);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__48527,seq48526__$1);
});
...
var vec__48540 = cljs.core.split_with.call(null,(function (p1__48539_SHARP_){
return cljs.core.not_EQ_.call(null,p1__48539_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__48540,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__48540,(1),null);
...
var vec__48543 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__48543,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__48543,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__48546 = cljs.core.rest.call(null,remaining_tokens);
var G__48547 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__48546;
name_tokens = G__48547;
continue;
} else {
...
var vec__48550 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__48550,(0),null);
var arity = cljs.core.nth.call(null,vec__48550,(1),null);
var vec__48553 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__48553,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__48553,(1),null);
var vec__48556 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__48556,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__48556,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__48556,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__48556,(3),null);
...
var vec__48562 = result;
var munged_ns = cljs.core.nth.call(null,vec__48562,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__48562,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__48562,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__48562,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__48562,(4),null);
var arity = cljs.core.nth.call(null,vec__48562,(5),null);
...
if(cljs.core.truth_(temp__5276__auto__)){
var vec__48566 = temp__5276__auto__;
var munged_name = cljs.core.nth.call(null,vec__48566,(0),null);
var args = cljs.core.nth.call(null,vec__48566,(1),null);
var vec__48569 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__48569,(0),null);
var name = cljs.core.nth.call(null,vec__48569,(1),null);
...
var G__48572 = (arity + (1));
var G__48573 = (function (){var temp__5276__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5276__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__48574){
var vec__48575 = p__48574;
var arity = cljs.core.nth.call(null,vec__48575,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__48575,(1),null);
...
var fixed_arities = devtools.munging.collect_fn_fixed_arities.call(null,f,(function (){var or__30182__auto__ = max_fixed_arity;
if(cljs.core.truth_(or__30182__auto__)){
return or__30182__auto__;
} else {
...
return cljs.core.get.call(null,arities,p1__48578_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__48579_SHARP_);
...
var args__31466__auto__ = [];
var len__31459__auto___48586 = arguments.length;
var i__31460__auto___48587 = (0);
while(true){
if((i__31460__auto___48587 < len__31459__auto___48586)){
args__31466__auto__.push((arguments[i__31460__auto___48587]));

var G__48588 = (i__31460__auto___48587 + (1));
i__31460__auto___48587 = G__48588;
continue;
} else {
}
break;
...
var argseq__31467__auto__ = ((((1) < args__31466__auto__.length))?(new cljs.core.IndexedSeq(args__31466__auto__.slice((1)),(0),null)):null);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__31467__auto__);
});

devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__48582){
var vec__48583 = p__48582;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__48583,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq48580){
var G__48581 = cljs.core.first.call(null,seq48580);
var seq48580__$1 = cljs.core.next.call(null,seq48580);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__48581,seq48580__$1);
});
...
return devtools.munging.args_lists_to_strings.call(null,devtools.munging.arities_to_args_lists.call(null,(function (){var or__30182__auto__ = devtools.munging.collect_fn_arities.call(null,f);
if(cljs.core.truth_(or__30182__auto__)){
return or__30182__auto__;
} else {
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_((function (){var and__30170__auto__ = include_ns_QMARK_;
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(include_protocol_ns_QMARK_)?protocol_ns:null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(((!(cljs.core.empty_QMARK_.call(null,protocol_name)))?[cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(include_protocol_ns_QMARK_)?".":null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(protocol_name)].join(''):null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(((!(cljs.core.empty_QMARK_.call(null,protocol_method)))?[cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_((function (){var or__30182__auto__ = include_protocol_ns_QMARK_;
if(cljs.core.truth_(or__30182__auto__)){
return or__30182__auto__;
} else {
...
var map__48591 = options;
var map__48591__$1 = ((((!((map__48591 == null)))?((((map__48591.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__48591.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__48591):map__48591);
var include_ns_QMARK_ = cljs.core.get.call(null,map__48591__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__48591__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__48591__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__48591__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__48592 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__48592,(0),null);
var fn_name = cljs.core.nth.call(null,vec__48592,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__48592,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__48592,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__48592,(4),null);
var arity = cljs.core.nth.call(null,vec__48592,(5),null);
...
var protocol_part = (cljs.core.truth_((function (){var and__30170__auto__ = protocol_ns;
if(cljs.core.truth_(and__30170__auto__)){
return cljs.core.not.call(null,(function (){var and__30170__auto____$1 = silence_common_protocols_QMARK_;
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var or__30182__auto__ = protocol_part;
if(cljs.core.truth_(or__30182__auto__)){
return or__30182__auto__;
} else {
return fn_part;
...
var o__47624__auto__ = f;
return (o__47624__auto__["getBasis"]).call(o__47624__auto__);
});
/**
...
if(cljs.core.truth_((function (){var and__30170__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__30170__auto__)){
...
}catch (e48596){var _e__47631__auto__ = e48596;
...
var G__48597 = (obj[cljs.core.first.call(null,path)]);
var G__48598 = cljs.core.rest.call(null,path);
obj = G__48597;
path = G__48598;
continue;
} else {
...
var partition_bits = (function (){var or__30182__auto__ = (obj[partition_key]);
if(cljs.core.truth_(or__30182__auto__)){
return or__30182__auto__;
} else {
return (0);
...
return (function (accum,p__48599){
var vec__48600 = p__48599;
var bit = cljs.core.nth.call(null,vec__48600,(0),null);
var protocol = cljs.core.nth.call(null,vec__48600,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__48603){
var vec__48604 = p__48603;
var ns = cljs.core.nth.call(null,vec__48604,(0),null);
var name = cljs.core.nth.call(null,vec__48604,(1),null);
var selector = cljs.core.nth.call(null,vec__48604,(2),null);
...
return (function (p__48608){
var vec__48609 = p__48608;
var munged_name = cljs.core.nth.call(null,vec__48609,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__48609,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__48609,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__48607_SHARP_){
return (obj[cljs.core.first.call(null,p1__48607_SHARP_)]);
});})(name,sorted_matches,vec__48609,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1511550780033
