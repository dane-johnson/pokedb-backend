...
var G__36112 = format;
var G__36112__$1 = (((G__36112 instanceof cljs.core.Keyword))?G__36112.fqn:null);
switch (G__36112__$1) {
case "transit":
return ajax.transit.transit_request_format.cljs$core$IFn$_invoke$arity$1(format_params);
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(format),(function (){var G__36114 = cljs.core.second(format);
var G__36115 = format_params;
return (ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2 ? ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2(G__36114,G__36115) : ajax.easy.keyword_response_format_element.call(null,G__36114,G__36115));
})()], null);
} else {
if(cljs.core.map_QMARK_(format)){
return format;
...
if(cljs.core.vector_QMARK_(format)){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.vector,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__36118_SHARP_){
return ajax.easy.keyword_response_format_element(p1__36118_SHARP_,format_params);
}),format));
} else {
 ...
 */
ajax.easy.transform_handler = (function ajax$easy$transform_handler(p__36119){
...
var handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36120__$1,cljs.core.cst$kw$handler);
var error_handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36120__$1,cljs.core.cst$kw$error_DASH_handler);
var finally$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36120__$1,cljs.core.cst$kw$finally);
var h = (function (){var or__30182__auto__ = handler;
...
var e = (function (){var or__30182__auto__ = error_handler;
if(cljs.core.truth_(or__30182__auto__)){
return or__30182__auto__;
} else {
...
return ((function (h,e,map__36120,map__36120__$1,handler,error_handler,finally$){
return (function ajax$easy$transform_handler_$_easy_handler(p__36122){
var vec__36123 = p__36122;
var ok = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36123,(0),null);
var result = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36123,(1),null);
var fexpr__36126_36127 = (cljs.core.truth_(ok)?h:e);
(fexpr__36126_36127.cljs$core$IFn$_invoke$arity$1 ? fexpr__36126_36127.cljs$core$IFn$_invoke$arity$1(result) : fexpr__36126_36127.call(null,result));
...
;})(h,e,map__36120,map__36120__$1,handler,error_handler,finally$))
});
ajax.easy.transform_opts = (function ajax$easy$transform_opts(p__36128){
...
var method = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36129__$1,cljs.core.cst$kw$method);
var format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36129__$1,cljs.core.cst$kw$format);
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36129__$1,cljs.core.cst$kw$response_DASH_format);
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36129__$1,cljs.core.cst$kw$params);
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36129__$1,cljs.core.cst$kw$body);

var needs_format = ((body == null)) && (cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(method,"GET"));
var rf = (cljs.core.truth_((function (){var or__30182__auto__ = format;
if(cljs.core.truth_(or__30182__auto__)){
return or__30182__auto__;
} else {
return needs_format;
