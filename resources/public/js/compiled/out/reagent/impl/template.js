...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__30853__auto__,writer__30854__auto__,opt__30855__auto__){
return cljs.core._write(writer__30854__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__36469 = o;
(G__36469[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__36470__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__36470 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__36471__i = 0, G__36471__a = new Array(arguments.length -  0);
while (G__36471__i < G__36471__a.length) {G__36471__a[G__36471__i] = arguments[G__36471__i + 0]; ++G__36471__i;}
  args = new cljs.core.IndexedSeq(G__36471__a,0,null);
} 
return G__36470__delegate.call(this,args);};
G__36470.cljs$lang$maxFixedArity = 0;
G__36470.cljs$lang$applyTo = (function (arglist__36472){
var args = cljs.core.seq(arglist__36472);
...
if(cljs.core.truth_((function (){var and__30170__auto__ = !((jsprops == null));
if(and__30170__auto__){
var and__30170__auto____$1 = jsprops.hasOwnProperty("onChange");
...
var G__36475 = jsprops;
(G__36475["defaultValue"] = value);

(G__36475["onChange"] = ((function (G__36475,v,value,on_change){
return (function (p1__36474_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__36474_SHARP_);
});})(G__36475,v,value,on_change))
);
...
var vec__36478 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36478,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36478,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36478,(2),null);
...
var jsprops = ({"argv": v});
var temp__5282__auto___36482 = reagent.impl.template.key_from_vec(v);
if((temp__5282__auto___36482 == null)){
} else {
var key_36483 = temp__5282__auto___36482;
(jsprops["key"] = key_36483);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__36484 = reagent.impl.template.__GT_NativeWrapper();
(G__36484["name"] = c);
...
var G__36485 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__36485) : reagent.impl.template.as_element.call(null,G__36485));
} else {
...
var len__31459__auto___36490 = arguments.length;
var i__31460__auto___36491 = (0);
while(true){
if((i__31460__auto___36491 < len__31459__auto___36490)){
args__31466__auto__.push((arguments[i__31460__auto___36491]));

var G__36492 = (i__31460__auto___36491 + (1));
i__31460__auto___36491 = G__36492;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__31467__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq36488){
var G__36489 = cljs.core.first(seq36488);
var seq36488__$1 = cljs.core.next(seq36488);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__36489,seq36488__$1);
});
...
break;
default:
var G__36495 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null);
v = G__36495;
continue;
...
var n__31225__auto___36497 = a.length;
var i_36498 = (0);
while(true){
if((i_36498 < n__31225__auto___36497)){
(a[i_36498] = reagent.impl.template.as_element((a[i_36498])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__31225__auto___36500 = a.length;
var i_36501 = (0);
while(true){
if((i_36501 < n__31225__auto___36500)){
var val_36502 = (a[i_36501]);
if((cljs.core.vector_QMARK_(val_36502)) && ((reagent.impl.template.key_from_vec(val_36502) == null))){
(o["no-key"] = true);
} else {
}

(a[i_36501] = reagent.impl.template.as_element(val_36502));

var G__36503 = (i_36501 + (1));
i_36501 = G__36503;
continue;
} else {
}
...
var ctx = ({});
var vec__36504 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36504,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36504,(1),null);
...
var G__36507 = (cljs.core.count(argv) - first_child);
switch (G__36507) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv(((function (G__36507){
